...
- **相關概念**：[[state-externalized-skill-composition]], [[prompt-version-management]], [[persistent-agent-session-restoration]], [[acp-agent-backend-for-ides]], [[multi-platform-agent-gateway]], [[natural-language-cron-agent-automation]], [[agentic-engineering-tco-curve]]
- **深度等級**：2/4
- **最後更新**：2026-05-13
...
- [[state-externalized-skill-composition]]: Structured handoffs keep durable workflow state outside the context window, leaving only decision-relevant context active.
- [[bounded-agent-cognitive-state]]: Uses a fixed schema as a stricter alternative to repeatedly compressing a growing history.
- [[context-rot-aware-context-management]]: Explains the quality signals that should trigger proactive compression and pruning.
...
- [[agentic-engineering-tco-curve]]: Compressing context can lower the recurring token cost that shapes an agentic system's total cost of ownership.
